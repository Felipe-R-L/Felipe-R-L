...
<p align="left">
  ...
  <a href="https://feliperl.space" target="_blank">
    <img src="https://img.shields.io/badge/Portfolio-feliperl.space-blue?style=for-the-badge&logo=vercel" alt="Portfolio">
  </a>
</p>
...
* **Methodologies & Principles:** `Agile (Scrum)`, `SOLID`, `Clean Architecture`, `DDD`
  ...
  <tr>
    <td align="center" style="width:50%; padding:10px;">
      <a href="https://git.io/streak-stats">
        <img src="https://github-readme-streak-stats.herokuapp.com/?user=felipe-r-l&theme=tokyonight&hide_border=true&date_format=j%20M%5B%20Y%5D" alt="GitHub Streak" />
      </a>
    </td>
    <td align="center" style="width:50%; padding:10px;">
      <a href="https://github.com/anuraghazra/github-readme-stats">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=felipe-r-l&theme=tokyonight&layout=compact&hide_border=true" alt="Most Used Languages" />
       </a>
    </td>
  </tr>
</table>
...
<div align="center">
  <a href="https://github.com/ashutosh00710/github-readme-activity-graph">
    <img src="https://github-readme-activity-graph.vercel.app/graph?username=felipe-r-l&bg_color=1a1b27&color=79dafa&line=2aa889&point=4485eb&area=true&hide_border=true" />
  </a>
</div>
...
* **Software Developer @ OMD do Brasil** (August 2024 - Present)
    * Key developer for a full-fledged SaaS platform in the agriculture business.
    * Major contributions include real-time communication with MQTT, telemetry data ingestion and back-end architecture, GCP service integration, Google Maps API and MapBox integrations in the front-end.
---

### 🌟 Projects

* **Project OMD Farm** | *NDA Protected*
    * Web ecosystem focused on precision agriculture, displaying telemetry data and providing integrations with the company's devices and products.
    * Multi-tenant SaaS: Rich, flexible entities and business structures for granular management and BI aggregations.
    * Contribution: Major architectural decisions, front-end and back-end development, CI/CD pipelines, deployments and documentation.
    * *Built with: Angular, TypeScript, Firebase, NestJS, etc.*

* **Project HSaSConnect** | *NDA Protected*
    * SaaS focused on monitoring ground bore equipment in real-time from the company's telemetry gateway devices.
    * Contribution: Designed and coded the diesel engine page, query performance and GCP cost optimizations.
...
* **DBs:** `PostgreSQL`, `TimescaleDB`, `Firestore`
* **DevOps & Cloud:** `Google Cloud Platform (GCP)`, `Digital Ocean`, `CI/CD`
